...
public class JobBO {
	...
	try {
	    ...
	    throw new IllegalStateException(
		    "Errore inaspettato nel record di ultima schedulazione job : "
    ...
    /**
     * Restituisce il nome dell'applicazione. Dovrebbe risiedere nello strato ejb ma al momento non
     * esiste alcun config helper per cui lo metto qui.
     *
     ...
     * in ingresso
     *
     * @param filtriJS     filtri job schedulati
     ...
     */
    public MonVLisSchedJobTableBean getMonVLisSchedJobViewBean(
	    GestioneJobForm.FiltriJobSchedulati filtriJS, Date[] dateValidate) throws EMFError {
