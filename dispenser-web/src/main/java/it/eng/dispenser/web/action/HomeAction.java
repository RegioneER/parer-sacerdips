    ...
    public void process() throws EMFError {
        ...
        try {
            ...
            if (getUser().getScadenzaPwd() != null) {
                ...
                int numGiorni = Integer.parseInt(applicationProperties.getProperty(
                        ConstDipParamApplic.NmParamApplic.NUM_GIORNI_ESPONI_SCAD_PSW.name()));
                ...
                if (cal.getTime().before(now) && getUser().getScadenzaPwd().after(now)) {
                    ...
                    getMessageBox()
                            .addError("Attenzione: la password scadr\u00E0 tra " + (int) diffGiorni
    ...
    public void changePwd() throws EMFError, IOException {
        ...
        this.getResponse()
                .sendRedirect(applicationProperties
                        .getProperty(ConstDipParamApplic.NmParamApplic.URL_MODIFICA_PASSWORD.name())
