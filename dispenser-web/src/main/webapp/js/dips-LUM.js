function dips_onLoad() {
    ...
    if ($('#anchorRicerca').length > 0) {
        ...
        /* Se si clicca nel menu di LUM il campo è vuoto quindi il cookie non va ripristinato,
...
var cookieName = "dispenser-LUM-id-paziente";

// Settaggio del cookie per LUM
function setCookie(cvalue) {
    document.cookie = cookieName + "=" + cvalue + ";";
}

// Lettura del cookie per LUM
function getCookie() {
    var name = cookieName + "=";
