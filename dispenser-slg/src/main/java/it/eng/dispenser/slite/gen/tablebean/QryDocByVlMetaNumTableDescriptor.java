 ...
 * @author Sloth
 *
 *         Bean per la tabella Qry_Doc_By_Vl_Meta_Num
 *
 */
public class QryDocByVlMetaNumTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Qry_Doc_By_Vl_Meta_Num /**/";
    public static final String TABLE_NAME = "Qry_Doc_By_Vl_Meta_Num";
	...
	map.put(COL_DL_VALORE, new ColumnDescriptor(COL_DL_VALORE, Types.DECIMAL, 22, false));
    }
