 ...
 * @author Sloth
 *
 *         Bean per la tabella Qry_Doc_By_Vl_Meta_Dt
 *
 */
public class QryDocByVlMetaDtTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Qry_Doc_By_Vl_Meta_Dt /**/";
    public static final String TABLE_NAME = "Qry_Doc_By_Vl_Meta_Dt";
	...
	map.put(COL_DL_VALORE, new ColumnDescriptor(COL_DL_VALORE, Types.TIMESTAMP, 11, false));
    }
