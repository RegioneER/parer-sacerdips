...
/**
 * RowBean per la tabella Qry_Doc_By_Vl_Meta_Num
 *
 */
public class QryDocByVlMetaNumRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public static QryDocByVlMetaNumTableDescriptor TABLE_DESCRIPTOR = new QryDocByVlMetaNumTableDescriptor();

    public QryDocByVlMetaNumRowBean() {
	super();
    }
	...
	QryDocByVlMetaNum entity = (QryDocByVlMetaNum) obj;
	this.setIdAttribDatiSpec(entity.getQryDocByVlMetaNumId().getIdAttribDatiSpec());
	this.setIdDoc(entity.getQryDocByVlMetaNumId().getIdDoc());
	this.setIdUnitaDoc(entity.getQryDocByVlMetaNumId().getIdUnitaDoc());
	this.setDlValore(entity.getDlValore());
    }

    @Override
    public QryDocByVlMetaNum rowBeanToEntity() {
	QryDocByVlMetaNumId id = new QryDocByVlMetaNumId();
	id.setIdAttribDatiSpec(this.getIdAttribDatiSpec());
	id.setIdDoc(this.getIdDoc());
	id.setIdUnitaDoc(this.getIdUnitaDoc());

	QryDocByVlMetaNum entity = new QryDocByVlMetaNum();
	entity.setQryDocByVlMetaNumId(id);
