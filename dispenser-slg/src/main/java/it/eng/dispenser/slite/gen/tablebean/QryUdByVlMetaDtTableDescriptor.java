 ...
 * @author Sloth
 *
 *         Bean per la tabella Qry_Ud_By_Vl_Meta_Dt
 *
 */
public class QryUdByVlMetaDtTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Qry_Ud_By_Vl_Meta_Dt /**/";
    public static final String TABLE_NAME = "Qry_Ud_By_Vl_Meta_Dt";
