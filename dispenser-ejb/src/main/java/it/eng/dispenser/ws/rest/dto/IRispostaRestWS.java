...
/**
 * Questa interfaccia prende il posto di IRispostaWS in SACER. Non è strettamente necessario
 * implementarla con questo nome, ma ho voluto mantenere lo stesso stile usato in preingest ed in
 * iam
 *
 * @author fioravanti_f
 */
