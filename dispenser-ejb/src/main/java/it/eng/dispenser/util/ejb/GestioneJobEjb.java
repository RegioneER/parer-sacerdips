...
public class GestioneJobEjb {
    ...
    public void ripristinaFotoGestioneJob() {
        ...
        for (DecJobFoto jobFoto : jobFotoList) {
            ...
            if (jobFoto.getDtProssimaAttivazioneFoto() != null) {
                DipDecJob job = helper.getEntityManager().find(DipDecJob.class,
                        jobFoto.getIdJobFoto());
    ...
    public BaseRow getInfoJobFotoRowBean() {
        ...
        row.setBigDecimal("ni_tot_job_disattivi2",
                BigDecimal.valueOf((long) numJobFoto - numJobAttivi));
                ...
                for (Object[] job : listaJob) {
                    ...
                    if (job[2] != null) {
                        ...
                        if ((String) job[9] == null
                                || (((String) job[9]).equals(Constants.StatoTimer.ATTIVO.name())
                                        || ((String) job[9])
                                                .equals(Constants.StatoTimer.DISATTIVO.name()))) {
                            attivo = true;
                        }
                    }
                ...
                for (Object[] job : listaJob) {
                    ...
                    if (job[2] != null) {
                        ...
                        if ((String) job[6] == null
                                || (((String) job[6]).equals(Constants.StatoTimer.ATTIVO.name())
                                        || ((String) job[6])
                                                .equals(Constants.StatoTimer.DISATTIVO.name()))) {
                            attivo = true;
                        }
