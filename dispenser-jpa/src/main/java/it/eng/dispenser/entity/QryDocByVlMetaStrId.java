...
@Embeddable
public class QryDocByVlMetaStrId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 67 * hash + Objects.hashCode(this.idAttribDatiSpec);
        hash = 67 * hash + Objects.hashCode(this.idDoc);
        hash = 67 * hash + Objects.hashCode(this.idUnitaDoc);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final QryDocByVlMetaStrId other = (QryDocByVlMetaStrId) obj;
