...
@Embeddable
public class QryUdByVlMetaDtId implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 71 * hash + Objects.hashCode(this.idAttribDatiSpec);
    ...
    public boolean equals(Object obj) {
        ...
        final QryUdByVlMetaDtId other = (QryUdByVlMetaDtId) obj;
