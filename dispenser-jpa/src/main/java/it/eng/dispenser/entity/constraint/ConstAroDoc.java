...
public class ConstAroDoc {
	...
	IN_ATTESA_MEMORIZZAZIONE, IN_ATTESA_SCHED, IN_VOLUME_APERTO, IN_VOLUME_CHIUSO,
	IN_VOLUME_DA_CHIUDERE, IN_VOLUME_IN_ERRORE, NON_SELEZ_SCHED
    }

    public enum TiStatoDocElencoVers {

	IN_ATTESA_MEMORIZZAZIONE, IN_ATTESA_SCHED, IN_ELENCO_APERTO, IN_ELENCO_CHIUSO,
	IN_ELENCO_DA_CHIUDERE, IN_ELENCO_FIRMATO, NON_SELEZ_SCHED
    }
