...
/**
 * The persistent class for the QRY_UD_BY_VL_META_STR database table.
 *
 */
@Entity
@Table(name = "QRY_UD_BY_VL_META_STR")
public class QryUdByVlMetaStr implements Serializable {
