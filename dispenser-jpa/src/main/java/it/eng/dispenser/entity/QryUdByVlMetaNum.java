...
/**
 * The persistent class for the QRY_UD_BY_VL_META_NUM database table.
 *
 */
@Entity
@Table(name = "QRY_UD_BY_VL_META_NUM")
public class QryUdByVlMetaNum implements Serializable {
