...
@Embeddable
public class QryDocByVlMetaNumId implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.idAttribDatiSpec);
        hash = 59 * hash + Objects.hashCode(this.idDoc);
        hash = 59 * hash + Objects.hashCode(this.idUnitaDoc);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final QryDocByVlMetaNumId other = (QryDocByVlMetaNumId) obj;
