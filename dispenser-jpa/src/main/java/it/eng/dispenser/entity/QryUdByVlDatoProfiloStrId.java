...
@Embeddable
public class QryUdByVlDatoProfiloStrId implements Serializable {
    ...
    public QryUdByVlDatoProfiloStrId() {
    }
    ...
    public int hashCode() {
        ...
        hash = 17 * hash + Objects.hashCode(this.idUnitaDoc);
        hash = 17 * hash + Objects.hashCode(this.tiDatoProfilo);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final QryUdByVlDatoProfiloStrId other = (QryUdByVlDatoProfiloStrId) obj;
